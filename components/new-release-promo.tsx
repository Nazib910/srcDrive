...
export function NewReleasePromo() {
  return (
    <section className="mt-12 sm:mt-16 md:mt-20 w-full px-4 sm:px-6 md:px-8">
      <div className="mx-auto max-w-4xl rounded-2xl sm:rounded-[40px] border border-border/50 dark:border-white/20 p-2 shadow-sm">
        <div className="relative mx-auto h-[300px] sm:h-[350px] md:h-[400px] max-w-4xl overflow-hidden rounded-xl sm:rounded-[38px] border border-border/50 dark:border-white/20 bg-primary p-2 shadow-sm">
          ...
          <div className="relative z-10">
            <div className="mt-4 sm:mt-6 md:mt-8 text-center">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary-foreground mb-3 sm:mb-4 md:mb-6 px-2">Build Your Next Project</h2>
              <p className="text-primary-foreground/80 mb-6 sm:mb-8 text-sm sm:text-base px-2">Partner with SRCDrive for professional solutions</p>
              <svg
                width="100"
                height="50"
                viewBox="0 0 100 50"
                ...
                className="fill-primary-foreground/80 dark:fill-white mx-auto mb-4 w-16 sm:w-20 h-auto"
                aria-hidden="true"
              >
              ...
              <div className="flex items-center justify-center">
                <a href="/signup">
                  <div className="group border-border bg-secondary/70 flex h-12 sm:h-14 md:h-16 cursor-pointer items-center gap-2 rounded-full border p-2 sm:p-2.5 md:p-3 mt-4 sm:mt-6 md:mt-10 min-h-[44px]">
                    <div className="border-border bg-primary flex h-9 sm:h-11 md:h-[43px] items-center justify-center rounded-full border min-h-[44px]">
                      <p className="mr-2 sm:mr-3 ml-1 sm:ml-2 md:ml-3 flex items-center justify-center gap-2 font-medium tracking-tight text-primary-foreground text-xs sm:text-sm md:text-base">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="18"
                          height="18"
                    ...
                    <div className="border-border flex size-6 sm:size-7 md:size-[26px] items-center justify-center rounded-full border-2 transition-all ease-in-out group-hover:ml-2 min-h-[44px]">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="16"
                        ...
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        className="lucide lucide-arrow-right transition-all ease-in-out group-hover:rotate-45 text-foreground"
                        aria-hidden="true"
                      >
            ...
            <h1
              className="absolute inset-x-0 mt-16 sm:mt-20 md:mt-24 text-center text-4xl sm:text-6xl md:text-[100px] font-semibold text-transparent pointer-events-none hidden sm:block"
              style={{
            ...
            <h1
              className="absolute inset-x-0 mt-16 sm:mt-20 md:mt-24 text-center text-4xl sm:text-6xl md:text-[100px] font-semibold text-primary pointer-events-none hidden sm:block"
              aria-hidden="true"
            >
              SRCDrive
            </h1>
