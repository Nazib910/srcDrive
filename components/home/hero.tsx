  ...
  return (
    <>
      <section className="relative overflow-hidden min-h-screen flex flex-col">
        <div className="container mx-auto px-4 py-16 sm:py-24 md:py-32 lg:py-40 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              <Badge variant="secondary" className="inline-flex items-center gap-2 px-4 py-2 text-xs sm:text-sm">
            ...
            <motion.div
              ...
              className="mb-6 sm:mb-8"
            >
              <h1 id="main-title" className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-foreground">
                {t('hero.heading')}
              </h1>
            </motion.div>
            ...
            <motion.p
              ...
              className="mx-auto mb-8 sm:mb-12 max-w-2xl text-base sm:text-lg text-muted-foreground px-4 md:px-0"
            >
              {t('hero.description')}
            </motion.p>
            ...
            >
              ...
              <svg
                ...
                className="text-foreground mt-4 sm:mt-8 w-20 sm:w-24 h-auto"
                aria-hidden="true"
              >
              ...
              <div className="flex items-center justify-center">
                <a href="#contact">
                  <div className="group cursor-pointer border border-border bg-card gap-2 h-[50px] sm:h-[60px] flex items-center p-[8px] sm:p-[10px] rounded-full hover:scale-105 transition-transform">
                    <div className="border border-border bg-primary h-[34px] sm:h-[40px] rounded-full flex items-center justify-center text-primary-foreground">
                    ...
                    <div className="text-muted-foreground group-hover:ml-3 ease-in-out transition-all size-[20px] sm:size-[24px] flex items-center justify-center rounded-full border-2 border-border">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="14"
                        height="14"
