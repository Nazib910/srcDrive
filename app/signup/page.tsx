...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 sm:p-6">
      ...
      {/* Decorative elements */}
      <div className="absolute top-20 right-20 w-72 h-72 bg-primary/10 rounded-full blur-3xl hidden md:block" />
      <div className="absolute bottom-20 left-20 w-96 h-96 bg-primary/5 rounded-full blur-3xl hidden md:block" />
      ...
      >
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-muted-foreground text-sm sm:text-base">Join SRCDrive and start building amazing projects</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <div className="flex items-start gap-2">
              <input
                type="checkbox"
                id="terms"
                className="mt-1 rounded border-border bg-secondary text-primary focus:ring-primary/20 cursor-pointer"
                required
              />
